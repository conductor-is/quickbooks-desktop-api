...
export class CreditMemos extends APIResource {
   ...
   */
  create(params: CreditMemoCreateParams, options?: Core.RequestOptions): Core.APIPromise<QbdCreditMemo> {
  ...
  list(
    ...
    options?: Core.RequestOptions,
  ): Core.PagePromise<QbdCreditMemosCursorPage, QbdCreditMemo> {
    const { 'Conductor-End-User-Id': conductorEndUserId, ...query } = params;
    return this._client.getAPIList('/quickbooks-desktop/credit-memos', QbdCreditMemosCursorPage, {
      query,
      ...options,
      headers: { 'Conductor-End-User-Id': conductorEndUserId, ...options?.headers },
    });
...
export class QbdCreditMemosCursorPage extends CursorPage<QbdCreditMemo> {}

export interface QbdCreditMemo {
  /**
   ...
   */
  billingAddress: QbdCreditMemo.BillingAddress | null;
   ...
   * line item level.
   */
  class: QbdCreditMemo.Class | null;
   ...
   */
  documentTemplate: QbdCreditMemo.DocumentTemplate | null;
   ...
   * by default.
   */
  linkedTransactions: Array<QbdCreditMemo.LinkedTransaction>;
   ...
   */
  receivablesAccount: QbdCreditMemo.ReceivablesAccount | null;
   ...
   */
  salesRepresentative: QbdCreditMemo.SalesRepresentative | null;
   ...
   */
  salesTaxCode: QbdCreditMemo.SalesTaxCode | null;
   ...
   */
  salesTaxItem: QbdCreditMemo.SalesTaxItem | null;
   ...
   */
  shippingAddress: QbdCreditMemo.ShippingAddress | null;
   ...
   * overnight delivery.
   */
  shippingMethod: QbdCreditMemo.ShippingMethod | null;
   ...
   * discounts.
   */
  terms: QbdCreditMemo.Terms | null;
...
export namespace QbdCreditMemo {
  /**
   * The credit memo's billing address.
   */
...
CreditMemos.QbdCreditMemosCursorPage = QbdCreditMemosCursorPage;

export declare namespace CreditMemos {
  export {
    type QbdCreditMemo as QbdCreditMemo,
    QbdCreditMemosCursorPage as QbdCreditMemosCursorPage,
