...
export class SubtotalItems extends APIResource {
   ...
   */
  create(params: SubtotalItemCreateParams, options?: Core.RequestOptions): Core.APIPromise<QbdSubtotalItem> {
  ...
  ): Core.APIPromise<QbdSubtotalItem> {
  ...
  list(
    ...
    options?: Core.RequestOptions,
  ): Core.PagePromise<QbdSubtotalItemsCursorPage, QbdSubtotalItem> {
    const { 'Conductor-End-User-Id': conductorEndUserId, ...query } = params;
    return this._client.getAPIList('/quickbooks-desktop/subtotal-items', QbdSubtotalItemsCursorPage, {
      query,
      ...options,
      headers: { 'Conductor-End-User-Id': conductorEndUserId, ...options?.headers },
    });
...
export class QbdSubtotalItemsCursorPage extends CursorPage<QbdSubtotalItem> {}

export interface QbdSubtotalItem {
  /**
   ...
   */
  customFields: Array<QbdSubtotalItem.CustomField>;
...
export namespace QbdSubtotalItem {
...
SubtotalItems.QbdSubtotalItemsCursorPage = QbdSubtotalItemsCursorPage;

export declare namespace SubtotalItems {
  export {
    type QbdSubtotalItem as QbdSubtotalItem,
    QbdSubtotalItemsCursorPage as QbdSubtotalItemsCursorPage,
